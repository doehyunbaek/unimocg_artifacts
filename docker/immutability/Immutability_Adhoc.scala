...
import org.opalj.tac.fpcf.analyses.LazyAdHocCHAFieldImmutabilityAnalysis
    ...
    def evaluate(
        ...
        val dependencies: List[FPCFAnalysisScheduler] =
            List(
                ...
                {
                    if (adHocCHA) {
                        LazyAdHocCHAFieldImmutabilityAnalysis
                    } else
                        ...
                        analysis match {
                            ...
                            case Fields =>
                                if (css.contains(LazyFieldImmutabilityAnalysis) ||
                                  css.contains(LazyAdHocCHAFieldImmutabilityAnalysis))
                                    allFieldsInProjectClassFiles.foreach(
